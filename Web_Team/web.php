...
<head>
    ...
    <style type="text/css">
      @media screen and (min-width: 50em){.imgger:nth-of-type(4n) {
    margin-right: 10px;
}}
        .fixed-nav {
            position: fixed;
...
<body>
    ...
    <div class="container" style="border-bottom:1px solid #e0e0e0;font-size:50px;">
        <div class="col m12 l12 s12">Web Team</div>
        <div class="row"></div>
    </div>
        ...
        <div id="main">
            ...
            <div class="imgger">
                    <div class="im">
                        ...
                        <div id="details">
                        <font size="5" style="line-height:10px;"><b><i>Vaibhav</i></b></font><br>
                        <hr>
            ...
            <div class="imgger">
                    <div class="im">
                        <img class="w_photo" src="images/ssap/sachin.jpg">
                        <div id="details">
                        <font size="5" style="line-height:10px;"><b>Sachin</b></font><br>
                        <hr>
                        <h6>4<sup>th</sup>Yr. B.Arch<br>IIT Kharagpur<br>Phone: +91-9421847955</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="imgger">
                    <div class="im">
                        <img class="w_photo" src="images/ssap/roshni.jpg">
                        <div id="details">
                        <font size="5" style="line-height:10px;"><b>Roshni</b></font><br>
                        <hr>
                        <h6>4<sup>th</sup>Yr. B.Arch<br>IIT Kharagpur<br>Phone: +91-8017740917</h6>
                        </div>
                    </div>
                </div>
            <div id="imgg">
                ...
                <div class="imgger">
                    <div class="im">
                        <img class="w_photo" src="images/ssap/rohit.jpg">
                        <div id="details">
                        <font size="5" style="line-height:10px;"><b>Rohit</b></font><br>
                        <hr>
                        <h6>5<sup>th</sup>Yr. B.Arch<br>IIT Kharagpur<br>Phone: +91-8768995553</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="imgger">
                    <div class="im">
                        <img class="w_photo" src="images/ssap/paras.jpg">
                        <div id="details">
                        <font size="5" style="line-height:10px;"><b><i>Paras</i></b></font><br>
                        <hr>
                        <h6>5<sup>th</sup>Yr. B.Arch<br>IIT Kharagpur<br>Phone: +91-7407210007</h6>
                        </div>
                    </div>
                </div>
